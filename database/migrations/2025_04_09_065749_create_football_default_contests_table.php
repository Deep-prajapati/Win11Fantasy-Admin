...
return new class extends Migration
{
    ...
    {
        Schema::create('football_default_contests', function (Blueprint $table) {
            $table->id();
            $table->integer('contest_type')->nullable();
            $table->integer('mrp')->default(0);
            $table->integer('entry_fees')->nullable();
            $table->unsignedBigInteger('total_spots')->default(0);
            $table->unsignedBigInteger('bot_user')->default(0);
    ...
    {
        Schema::dropIfExists('football_default_contests');
    }
};
