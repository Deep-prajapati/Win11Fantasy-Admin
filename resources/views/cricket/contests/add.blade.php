    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('admin.cricket.default.contest.add') }}" method="POST">
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <label for="contest_type_select" class="form-label">
                            Contest Type
                        </label>
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="number" min="1" step="0.01" class="form-control @error('mrp') is-invalid @enderror" id="mrp" name="mrp" value="{{ old('mrp',1) }}" placeholder="Contest MRP">
                        @error('mrp')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <label for="usable_bonus" class="form-label">
                            Usable Bonus (₹)
                        </label>
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <label for="first_price" class="form-label">
                            First Prize
                        </label>
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <label for="total_bots" class="form-label">
                            Total Bots
                        </label>
                        <input type="number" min="0" class="form-control @error('total_bots') is-invalid @enderror"
                            id="total_bots" name="total_bots" value="{{ old('total_bots') }}" placeholder="Total Bots">
                        @error('total_bots')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-check form-switch mb-2">
                            <input class="form-check-input" type="checkbox" id="is_felexible" name="is_felexible"
                                {{ old('is_felexible') ? 'checked' : '' }}>
                            <label class="form-check-label" for="is_felexible">Is Flexible Contest</label>
                        </div>
                    </div>
                </div>

                <div class="row mb-2 {{ old('is_felexible') ? '' : 'd-none' }}" id="commission-row">
                    <div class="col-sm-4">
                        ...
                        <input type="number" min="1" class="form-control @error('admin_commission') is-invalid @enderror"
                            id="admin_commission" name="admin_commission" value="{{ old('admin_commission') }}" placeholder="Admin Commission">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="number" min="1" class="form-control @error('dis_commission') is-invalid @enderror"
                            id="dis_commission" name="dis_commission" value="{{ old('dis_commission') }}" placeholder="Distributed Commission">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="number" min="1" class="form-control @error('dis_amount') is-invalid @enderror"
                                id="dis_amount" name="dis_amount" value="{{ old('dis_amount') }}" placeholder="Distributed Amount">
                        @error('dis_amount')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    @else
                        <div class="row price-row">
                            <div class="col-4">
                                ...
                                <input type="number" min="0" class="form-control from_rank" name="from_rank[]" placeholder="From rank">
                            </div>
                            <div class="col-4">
                                <label for="to_rank" class="form-label">To rank</label>
                                <input type="number" min="0" class="form-control to_rank" name="to_rank[]" placeholder="To rank">
                            </div>
                            <div class="col-4">
                                <label for="prize" class="form-label">Prize</label>
                                <input type="number" min="0" class="form-control prize" name="prize[]" placeholder="Prize">
                            </div>
                        </div>
                    @endif
                </div>
