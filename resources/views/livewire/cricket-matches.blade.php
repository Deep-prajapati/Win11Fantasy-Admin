            ...
            <div class="col-sm-4 mb-3">
                ...
                <select class="form-select" wire:model.live="league">
                    ...
                    @foreach ($leagues as $league)
                        <option value="{{ $league->league_id }}">{{ $league->name }} ({{ $league->code }})</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="col-sm-4 mb-3">
                ...
                <select class="form-select" wire:model.live="season">
                    ...
                    @foreach ($seasons as $season)
                        <option value="{{ $season->season_id }}">{{ $season->name }} ({{ $season->code }})</option>
                    @endforeach
                </select>
            </div>
            ...
            <tbody>
                @forelse ($matches as $key => $match)
                    <tr>
                        ...
                        <td><a
                                href="{{ route('admin.cricket.match.contests.list', $match->fixture_id) }}">{{ $match->fixture_id }}</a>
                        </td>
