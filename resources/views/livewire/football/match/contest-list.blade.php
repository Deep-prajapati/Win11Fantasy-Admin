                 ...
                 <tbody class="table-border-bottom-0">
                     ...
                     @foreach ($contests as $key => $contest)
                         <tr>
                             ...
                             <td><a
                                     href="{{ route('admin.football.match.contests.view', ['match_id' => $fixture->match_id, 'contest_id' => $contest->id]) }}">{{ $contest->id }}</a>
                             </td>
                             ...
                             <td>{{ $contest->max_entries }} <span class="small text-info">*Per
                                     User</span></td>
