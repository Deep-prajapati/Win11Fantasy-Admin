...
@section('contents')
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('admin.football.default.contest.add') }}" method="POST">
                @csrf
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="number" min="1" class="form-control @error('max_entries') is-invalid @enderror"
                            id="max_entries" name="max_entries" value="{{ old('max_entries',1) }}" placeholder="Max entries">
                        @error('max_entries')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        ...
                        <input type="number" min="0" class="form-control @error('total_bots') is-invalid @enderror"
                            id="total_bots" name="total_bots" value="{{ old('total_bots',0) }}" placeholder="Total Spots">
                        @error('total_bots')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
