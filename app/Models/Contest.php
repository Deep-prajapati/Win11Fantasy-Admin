...
class Contest extends Model
{
    ...
    {
        return $this->belongsTo(DefaultContest::class, 'default_contest_id', 'id');
    }
    public function prizeBreakups()
    {
        return $this->hasMany(PrizeBreakup::class, ['default_contest_id', 'contest_type_id'], ['default_contest_id', 'contest_type']);
    }
    ...
    {
        return $this->hasOne(Fixture::class, 'fixture_id', 'match_id');
    }
}
